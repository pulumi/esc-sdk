...
ESC SDK uses OpenAPI Generator to auto-generate the raw TypeScript, Python, and C# API clients from the `swagger.yaml` definition. The Go SDK calls Pulumi Cloud through [`github.com/pulumi/pulumi-cloud-sdk/go`](https://github.com/pulumi/pulumi-cloud-sdk) and is not generated here.
