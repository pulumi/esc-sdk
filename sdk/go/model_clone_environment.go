...
func (o *CloneEnvironment) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *CloneEnvironment) GetVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *CloneEnvironment) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *CloneEnvironment) SetVersion(v int32) {
	o.Version = &v
}
