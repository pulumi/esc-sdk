...
// checks if the UpdateEnvironmentTagNewTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateEnvironmentTagNewTag{}
...
type _UpdateEnvironmentTagNewTag UpdateEnvironmentTagNewTag

// NewUpdateEnvironmentTagNewTag instantiates a new UpdateEnvironmentTagNewTag object
...
func NewUpdateEnvironmentTagNewTag(name string, value string) *UpdateEnvironmentTagNewTag {
	this := UpdateEnvironmentTagNewTag{}
	this.Name = name
	this.Value = value
	return &this
}

// NewUpdateEnvironmentTagNewTagWithDefaults instantiates a new UpdateEnvironmentTagNewTag object
...
func (o *UpdateEnvironmentTagNewTag) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateEnvironmentTagNewTag := _UpdateEnvironmentTagNewTag{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// Allow unknown fields to be lenient with API responses that may include extra fields
	err = decoder.Decode(&varUpdateEnvironmentTagNewTag)

	if err != nil {
		return err
	}

	*o = UpdateEnvironmentTagNewTag(varUpdateEnvironmentTagNewTag)

	return err
}

type NullableUpdateEnvironmentTagNewTag struct {
	value *UpdateEnvironmentTagNewTag
	isSet bool
}
...
func NewNullableUpdateEnvironmentTagNewTag(val *UpdateEnvironmentTagNewTag) *NullableUpdateEnvironmentTagNewTag {
	return &NullableUpdateEnvironmentTagNewTag{value: val, isSet: true}
}
