...
class EscClient:
    ...
    def clone_environment(self, org_name: str, src_project_name: str, src_env_name: str, dest_project_name: str, dest_env_name: str, clone_options: dict = {}) -> models.Environment:
        ...
        :key int version: Description of what option4 does.
        :key bool preserve_access: Description of what option1 does.
        :key bool preserve_environment_tags: Description of what option2 does. This option controls X.
        :key bool preserve_history: Description of what option2 does. This option controls X.
        :key bool preserve_revision_tags: Description
        :return: The created environment."""
