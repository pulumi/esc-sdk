...
class EnvironmentDiagnosticsResponse(BaseModel):
    ...
    """ # noqa: E501
    diagnostics: Optional[List[EnvironmentDiagnostic]] = Field(default=None, description="The list of diagnostics produced by the environment operation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentDiagnosticsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentDiagnosticsResponse from a dict"""
        if obj is None:
            return None
