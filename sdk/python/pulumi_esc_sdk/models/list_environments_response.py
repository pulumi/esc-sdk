...
class ListEnvironmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    environments: List[OrgEnvironment] = Field(description="The list of environments")
    next_token: Optional[StrictStr] = Field(default=None, description="Token for fetching the next page of results", alias="nextToken")
